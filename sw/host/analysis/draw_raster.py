...
def draw_raster(path, save=False, delimiter=';'):
    FONTSIZE   = 12
    ...
    if save:
        fig.savefig('raster_{}.tiff'.format('_'.join("raster")), dpi=600, format="tiff", pil_kwargs={"compression": "tiff_lzw"})


# #Original From Romain:
